...
//
	...
	//
	DEFINE('APPNAME', 'idae-'.$host_name.'-preprod-lan');
	...
	if (!function_exists("my_autoloader")) {
		function my_autoloader($class_name) {
			...
			if (file_exists(APPCLASSES . 'Class' . $class_name . '.php')):
				require_once(APPCLASSES . 'Class' . $class_name . '.php');
			elseif(file_exists(APPCLASSES . '/appcommon/Class' . $class_name . '.php')):
				require_once(APPCLASSES . 'appcommon/Class' . $class_name . '.php');
			elseif (file_exists(OLDAPPCLASSES . 'Class' . $class_name . '.php')):
				require_once(OLDAPPCLASSES . 'Class' . $class_name . '.php');
			else:
				$folder     = APPCLASSES;
				...
				if (file_exists($folder . $fileName)) include $folder . $fileName;
			endif;
		}
