...
?>
<div class=" relative borderr borderb cursor" >
	<div class="relative mastershow flex_h" ondblclick="<?=fonctionsJs::app_fiche($table,$table_value)?>" >
		...
		<div style="background-color: rgba(255,255,255,0.9);" class="tile" data-contextual="table=<?= $table ?>&table_value=<?= $table_value ?>" data-table="<?=$table?>"  data-table_value="<?=$table_value?>">
