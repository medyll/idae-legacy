<?php
	...
	$rs                   = $APP_SCHEME->find(['$or' => [['codeAppscheme_type' => 'CONF'], ['codeAppscheme' => 'agent'], ['codeAppscheme' => 'agent_groupe'], ['codeAppscheme' => 'agent_groupe_droit']]]);
	...
	while ($arr = $rs->getNext()) {
		...
		while ($arr_tmp = $rs_tmp->getNext()) {
			if ($table == 'agent') continue; // pas export agent
