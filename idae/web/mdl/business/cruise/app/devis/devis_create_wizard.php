...
<div onclick = "document.getElementById('uniqu_cw').style.display='';document.getElementById('div_produit_liste_devis').toggleContent();load_table_in_zone(serializeFields(this),'table_produit_devis_make');" >
