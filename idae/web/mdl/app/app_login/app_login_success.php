<!-- <?php
	...
	$idAgent = isset($_SESSION['idagent']) ? $_SESSION['idagent'] : 0;
?>
<div class="" style="text-align: left;">
	<div class="inline boxshadow" style="z-index:1;bottom:2em;right:2em;"  >
		<img src="<?=Act::imgApp('agent', $idAgent, 'square');?>">
	</div>
	<div class=" aligncenter padding margin borderb bold"><?= isset($arrAgent['prenomAgent']) ? $arrAgent['prenomAgent'] : 'Invité' ?></div>
