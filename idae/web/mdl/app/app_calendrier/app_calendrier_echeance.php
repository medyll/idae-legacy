...
<div style="width:750px;">
	<div class="titre_entete applink alignright">
		<a onclick="<?=fonctionsJs::app_create('tache')?>"><i class="fa fa-<?=$APP->iconAppscheme?>"></i> <?= idioma('Nouvelle tache') ?></a></div>
...
<script>
	...
	document.getElementById('cal_echeance').observe ('dom:act_click', function (event) {
