 ...
 */
	...
	$maxcount = $rs->count();
	// $page/$nbRows come straight off $_POST as strings; App::query() is typed int since the
	// PHP 8 migration and fatals on them.
	$rs = $APP->query($vars + $where, (int)$page, (int)$nbRows)->sort(array($sortBy => $sortDir));
	//
