# MIGR-Q.md — Technical Implementation Guide for Node.js/HTML Recreation
...
```javascript
// appscheme - Entity/Table definitions
{
  _id: ObjectId("..."),
  idappscheme: 1,
  codeAppscheme: "produit",           // Entity code (e.g., "product")
  nomAppscheme: "Produit",            // Display label
  codeAppscheme_base: "sitebase_app", // Namespace/base
  hasTypeScheme: 1,                   // Has type taxonomy
  hasCodeScheme: 1,                   // Has code field
  hasOrdreScheme: 1,                  // Has ordering
  grilleFK: [                         // Forward FK relationships
...
// appscheme_field - Reusable field definitions
{
  _id: ObjectId("..."),
  idappscheme_field: 10,
  codeAppscheme_field: "nom",         // Field code (raw)
  nomAppscheme_field: "Nom",          // Display label
  codeAppscheme_field_type: "text",   // Type: text, number, date, fk, etc.
...
// appscheme_has_field - Entity-field binding
{
  ...
  in_mini_fiche: 1,                   // Show in mini-card view
  in_list: 1                          // Show in list view
}
...
// appscheme_has_table_field - Cross-entity columns
{
  ...
  idappscheme: 1,
  idappscheme_field: 10,
  idappscheme_link: 2,                // Linked entity
  ordreAppscheme_has_table_field: 1
}

// appscheme_field_group - Field grouping for UI
{
  _id: ObjectId("..."),
...
// appscheme_base - Namespace/base definition
{
  _id: ObjectId("..."),
  idappscheme_base: 1,
...
function checkPermission(userId, permission, table = null) {
